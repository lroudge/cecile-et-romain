...
">
				...
				<ul>
					<li>
						En voiture : Prendre l'A13 pour venir en Normandie pour
					...
					<li>
						En train : Depuis Paris, prendre le train direction
					...
					<li>
						En avion : Direction Paris CDG, puis il faut prendre un
						autre moyen de transport.
					</li>
					<li>En tapis volant : Il trouvera tout seul.</li>
				</ul>
				<br />
				Château du Breuil : Domaine du Breuil, Les Jourdains, 14130 Le
				Breuil en Auge{" "}
				<a
					target="_blank"
					rel="noreferrer nooponer"
...
">
				...
				<ul>
					<li>
						En voiture : Prendre l'A13 puis la D579. (Ou utilisez
						Maps.)
					</li>
					<li>
						En train : Depuis Paris, prendre le train direction
					...
					<li>En tapis volant : Il sait où c'est.</li>
					<br />
					Bien entendu si vous avez la moindre question n'hésitez pas
