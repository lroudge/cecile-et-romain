					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								Cécile commence à vivre chez Romain, car après
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								Premier achat commun : La Nintendo Switch. On
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								Premières vacances ensemble : Direction
								l’Andalousie !
							</div>
							<img
								src="https://lh3.googleusercontent.com/pw/ACtC-3f7bpY5VRaNQqW0K5NzTa2hJK_iMTmJkZIZtRBzwQHUbNuTka3viIqxDNyWM5uNagMc3MbcAbVDzQN2davH9S7hAzBTxiH8x_S4f3MGpgi1F_A-UmrMVnSTy0P2gb6LxNTzaQc4eggEsrA6HGwZ7-AF=w962-h1442-no?authuser=0"
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								On se PACS ! C’est la suite logique de
								l’aventure (et ça facilite les déclarations
								d’impôts)
							</div>
							<img
								src="https://lh3.googleusercontent.com/pw/ACtC-3f7bpY5VRaNQqW0K5NzTa2hJK_iMTmJkZIZtRBzwQHUbNuTka3viIqxDNyWM5uNagMc3MbcAbVDzQN2davH9S7hAzBTxiH8x_S4f3MGpgi1F_A-UmrMVnSTy0P2gb6LxNTzaQc4eggEsrA6HGwZ7-AF=w962-h1442-no?authuser=0"
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								Les cartons sont faits, les bagages sont pliés,
								les visas sont imprimés : On s’envole pour les
								US !
							</div>
							<img
								src="https://lh3.googleusercontent.com/pw/ACtC-3f7bpY5VRaNQqW0K5NzTa2hJK_iMTmJkZIZtRBzwQHUbNuTka3viIqxDNyWM5uNagMc3MbcAbVDzQN2davH9S7hAzBTxiH8x_S4f3MGpgi1F_A-UmrMVnSTy0P2gb6LxNTzaQc4eggEsrA6HGwZ7-AF=w962-h1442-no?authuser=0"
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								<br />
								Suite aux problèmes de visa de Cécile, on décide
								de se fiancer en secret sur une plage à Santa
								Monica
							</div>
							<img
								src="https://lh3.googleusercontent.com/pw/ACtC-3f7bpY5VRaNQqW0K5NzTa2hJK_iMTmJkZIZtRBzwQHUbNuTka3viIqxDNyWM5uNagMc3MbcAbVDzQN2davH9S7hAzBTxiH8x_S4f3MGpgi1F_A-UmrMVnSTy0P2gb6LxNTzaQc4eggEsrA6HGwZ7-AF=w962-h1442-no?authuser=0"
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								Hall de San Francisco. L’histoire raconte qu’on
					...
					<li>
						<div className={styles.img_container}>
							<div>
								...
								Romain fait la vraie demande en mariage en haut
